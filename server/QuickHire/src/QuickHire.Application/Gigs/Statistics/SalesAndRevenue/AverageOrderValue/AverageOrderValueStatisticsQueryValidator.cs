...
public class AverageOrderValueStatisticsQueryValidator : AbstractValidator<AverageOrderValueStatisticsQuery>
{
    public AverageOrderValueStatisticsQueryValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()

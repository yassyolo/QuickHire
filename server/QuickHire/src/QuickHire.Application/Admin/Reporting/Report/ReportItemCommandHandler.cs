...
public class ReportItemCommandHandler : ICommandHandler<ReportItemCommand, Unit>
{
    ...
    Domain.Users.Enums.NotificationType.ReportedUser,
    new Dictionary<string, string>
    {
        ...
        else if (request.GigId.HasValue)
        {
            ...
            await _notificationService.MakeNotification(request.SellerId.Value, NotificationRecipientType.Seller, Domain.Users.Enums.NotificationType.ReportedGig,

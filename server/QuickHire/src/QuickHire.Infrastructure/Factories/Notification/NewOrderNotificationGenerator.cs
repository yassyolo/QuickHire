...
internal class NewOrderNotificationGenerator: INotificationGenerator
{
    public NotificationType Type => NotificationType.NewOrder;

    public string Title { get; set; } = "New order received!";
    public string Message { get; set; } = "Hello! you have received new order with number: {OrderNumber}.Check it out in the orders table!";

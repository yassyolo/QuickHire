...
internal class CustomOfferReceivedNotificationGenerator : INotificationGenerator
{
    ...
    public string Title { get; set; } = "New Custom Offer!";
    public string Message { get; set; } = "You have received a new custom offer. Check out your messages with {SellerUserName}!";

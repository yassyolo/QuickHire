...
import { Delivery, OrderDelivery } from "./OrderDelivery/OrderDelivery";
import { OrderReview } from "./OrderReview/OrderReview";
import { Review } from "../Reviews/ReviewsLIst/ReviewsList";
...
{view === "revisions" && (
    <>
        {order?.revision && order.revision.length > 0 ? (
            <div className="revisions-container" style={{width: '950px'}}>
            ...
            >
                ...
                <div className="no-content-title">No revisions for this order yet.</div>
            </div>
        )}
    </>
)}

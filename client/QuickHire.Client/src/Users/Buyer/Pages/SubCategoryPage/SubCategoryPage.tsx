    ...
    return (
        <div style={{ padding: "20px 80px" }}>
            ...
            {subCategories && subCategories.length > 0 &&
                <div className="subCategories-row" style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginTop: '20px' , marginBottom: '40px',}}>
                    {subCategories.map(subCategory => (
                        <div key={subCategory.id} className="subCategory-item" style={{ maxWidth: '250px', padding: '10px', border: '1px solid rgb(214, 213, 213)', borderRadius: '20px' }}>
            ...
            {loading ? (
                ...
                <>
                    {gigs.length === 0 ?  <div className="no-content" style={{ marginTop: "40px", justifyContent: "center", alignItems: "center", width: "100%" }}>
                                    ...
                                    <div className="no-content-title" style={{color: 'grey'}}>No gigs to see here</div>
                                </div> : (

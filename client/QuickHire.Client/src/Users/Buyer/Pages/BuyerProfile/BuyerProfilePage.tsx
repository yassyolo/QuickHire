...
import { AddBuyerDetailsModal } from "../../../../Shared/Modals/Add/BuyerDetails/AddBuyerDetails";
import { useAuth } from "../../../../AuthContext";
import { ProfileChecklist } from "./ProfileChecklist/ProfileChecklist";
import { EditBuyerDetailsModal } from "../../../../Shared/Modals/Add/BuyerDetails/EditBuyerDetails";
            ...
            <div className="buyer-profile-page-right">
                ...
                <div className="get-started-with-our-platform">
                    ...
                    <div className="get-started-with-our-platform-item item1">
                        <div className="link-to-create" onClick={handleCreateNewGigClick}>Create new gig <i className="bi bi-arrow-right"></i> </div>
                                            </div>
                    ...
                    <div className="get-started-with-our-platform-item item3">
                        <Link className="link-to-create" to={"/buyer"}> Start exploring <i className="bi bi-arrow-right"></i> </Link>
                    </div>
                </div>
                <ProfileChecklist
                    buyerDetails={

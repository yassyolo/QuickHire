...
export function PostProjectBriefForm() {
    ...
    const fetchSubSubCategories = async() => {
        try {
            const response = await axios.get<CategoryItem[]>("https://localhost:7267/admin/sub-sub-categories/populate");
    ...
    isValid: !!aboutBuyer && !!description && subSubCategoryId > 0,
      ...
      content: (
        <div className="wizard-form">
          <div className="brief-description-title"> Answer these questions in order for the seller to understand your requirements. </div>
          <FormGroup
            id={"aboutBuyer"}

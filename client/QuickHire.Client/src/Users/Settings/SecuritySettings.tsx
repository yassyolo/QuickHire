...
import { PasswordCheckItem } from "../Authtentication/PasswordCheckItem";
...
export function SecuritySettings({onSaveChanges}: SecuritySettingsProps) {
    ...
    const handleOnSaveChanges = () => {
        try{
            setValidationErrors({});
            const url = "https://localhost:7267/users/settings/security";
            axios.post(url, {
                newPassword,
                confirmPassword
            });
    ...
    return(
        ...
        <div className="security-settings-container">
            <FormGroup error={validationErrors.NewPassword || []} id="password" label="New password"   tooltipDescription="Use at least 8 characters with a mix of letters, numbers, and symbols to keep your account secure." type="password" value={newPassword} onChange={handleNewPasswordChange} ariaDescribedBy="password-help"/>
{newPassword &&
            ...
            <FormGroup error={validationErrors.ConfirmPassword || []} id="password" label="Confirm password"   tooltipDescription="Use at least 8 characters with a mix of letters, numbers, and symbols to keep your account secure." type="password" value={confirmPassword} onChange={handleConfirmPasswordChange} ariaDescribedBy="password-help"/>

...
import { GigFilter } from "../../../../Admin/Pages/Details/Categories/SubSubCategory/SubSubCategoryDetails";
...
//todo
      const response = await axios.post("https://localhost:7267/admin/sub-sub-categories", payload);

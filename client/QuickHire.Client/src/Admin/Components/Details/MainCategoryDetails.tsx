...
import { AddSubCategoryModal } from "../Modals/Add/AddSubCategoryModal";
  ...
  useEffect(() => {
    ...
    const fetchCategoryDetails = async () => {
      ...
      try {
        ...
        const response = await fetch(`https://localhost:7267/admin/main-categories/${parsedId}`);
        if (!response.ok) throw new Error("Failed to fetch main category details");
